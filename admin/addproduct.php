...
<body>
	...
	<div id="wrapper">
		...
		<br>
		<input type="file" class="form-control" placeholder="Enter Product Image" name="image" required="">
			<br>
		...
		<input type="text" class="form-control" placeholder="Enter Product Quantity" name="quantity" required="">
			<br> 
		<textarea class="form-control" placeholder="Enter Product Description" rows="4" name="text" required=""></textarea>
			<br>
