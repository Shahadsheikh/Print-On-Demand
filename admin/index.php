...
<body>
	...
	<?php include "sidebar.php" ?>
		...
		<div class="main-content"><br><br>
			...
			<!-- <img src="assets/img/ad.jpg" class="btn-toggle-fullwidth" class="lnr lnr-arrow-left-circle" height="70" width="70"> -->
			<h3 class="panel-title">Admin Overview</h3>
			<p class="panel-subtitle" style="color:black;font-size: 20px;" >Period: March 30, 2021 - Oct 21, 2025</p>
			</div>
			...
			?>
				...
				<span class="title">Registered Customer</span>
                   ...
                   <?php
			$stmtssss = $admin -> ret("SELECT COUNT(*) FROM `orderedproducts`");
			...
			<span class="title">Product available</span>
				</p>
					</div>
				</div>
