...
<div class="row">
  <div class="col-75">
    <div class="containe">
      <form action="usercontroller/order.php" method="POST">
        ...
        <input type="hidden" name="amount" value="<?= $amm?>">
        ...
        <div class="row">
          <div class="col-50">
            ...
            <input required="" type="text" id="fname" name="name" placeholder="Enter your full name">


            <label for="email"><i class="fa fa-envelope"></i> Email</label>
            <input required="" type="text" id="email" name="email" placeholder="Enter your Email">

              <label for="email"><i class="fa-cc-discover"></i>Phone number</label><br>
            <input required="" type="text" id="email" name="phone" maxlength="10" placeholder="Enter your phone no"><br>


            <br>
            <label for="adr"><i class="fa fa-address-card-o"></i> Address</label>
            <input required="" type="text" id="adr" name="address" placeholder="Enter your address">
            ...
            <div class="row">
              ...
              <div class="col-50">
                ...
                <input required="" type="text" id="zip" maxlength="6" name="pincode" placeholder="Enter Your pincode">
              </div>
            </div>
          </div>
  ...
  <input required="" type="radio" id="online" name="co" value="paid online">
  <label for="online">Debit/Credit</label>
            </div>
  ...
  <div class="col-25">
    <div class="containe" style="font-size:13px" >
      <h2>Your Orders <span class="price" style="color:black"><i class="fa fa-shopping-cart"></i> </span></h2>
          <?php
      ...
      <p><a href="#"></a><?php echo $arow['name']; ?>
      <span class="price">Rs. <?php echo ($arow['price'] - $arow['discount']) ." * ". $qty;
       $_SESSION['ammount']= ($arow['price'] - $arow['discount']) * $qty; ?></span></p>
      <hr>
