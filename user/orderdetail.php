...
<div class="containe">
    <article class="card">
        <header class="card-header" style="font-size:20px"> My Orders / Tracking </header>
        ...
        <div class="card-body">
            ...
            //  $stmtss = $admin -> ret("SELECT * FROM `sellerapprove` WHERE `sa_id`='$c'");
          ...
          <?php }else{ ?>
             <!-- <a href="cancelorder.php?or_id=<?=$a?>"><button class="btn btn-danger"> Cancel Order.</button></a> -->
         ...
         <!--    <div class="track">
                ...
                <div class="step <?php if($d=="completed" || $d=="Canceled"){ ?> active <?php } ?>"> <span class="icon"> <i class="fa fa-truck"></i> </span><h1> <span class="text"><?= $row['status']?></h1></span> </div>
...
<?php
             $astm = $admin -> ret("SELECT * FROM `orderedproducts` WHERE `u_id` = '$uid'");
...
<a href=""><button class="btn btn-danger"> Cancelled</button></a>
                      <?php  }else{ ?>
<a href="cancelorder.php?oor_id=<?=$rows['or_id']?>"><button class="btn btn-danger"> Cancel Order</button></a>
                     <?php   }?>
        ...
        <?php } ?>
            ...
            <hr> <a style="font-size:16px" href="firstproductpage.php" class="btn btn-warning" data-abc="true"> <i class="fa fa-chevron-left"></i > Back to orders</a>
        </div>
